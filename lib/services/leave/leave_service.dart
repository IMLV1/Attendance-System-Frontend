...
class LeaveRequestService {
  ...
  /// ช่วงวันที่ผู้ใช้ลาไปแล้ว (ไม่รวมใบที่ถูกปฏิเสธ) — ใช้ปิดวันในปฏิทิน
  ///
  /// 🚩 (2026-08-26) เดิมปฏิทินเลือกวันไหนก็ได้ ผู้ใช้กรอกครบ เซ็นชื่อ กดส่ง
  /// แล้วค่อยโดน backend ตอบ 409 ว่าลาซ้อนทับ — เสียเวลาเปล่าทั้งที่รู้ได้ตั้งแต่แรก
  Future<Response<dynamic>> getOccupiedDates() {
    return dio.get('/api/leave_request/occupied_dates');
  }
}
