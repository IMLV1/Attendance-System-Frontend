    ...
    return AppScaffold(
        ...
        content: SafeArea(
          child : SingleChildScrollView(
            padding: EdgeInsets.only(top:screenHeight*0.08, left: 20, right: 20, bottom: 20),
            child: Column(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                _buildStatusItem(iconPath: 'assets/images/in.svg', title: 'เช็คอิน', time: _hasCheckedIn ? currentTime : "---",isLast: false),
                _buildStatusItem(iconPath: 'assets/images/out.svg', title: 'เช็คเอาท์', time:hasCheckedOut ? currentTime : '---',isLast: true),
              ],
            ),
          )
        ],
      ...
      children: [
        ...
        if (!isLast)
          const Padding(
            ...
            child: Divider(height: 1, thickness: 2, color: AppColors.linegray),
          ),
      ],
    );
  }
