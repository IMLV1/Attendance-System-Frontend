...
class _TimeRequestCreateState extends State<TimeRequestCreate> {
  ...
  bool _isInvalidTimeRange() {
    if (_selectDate?.startTime == null || _selectDate?.endTime == null) {
      return false;
    }

    final start = _selectDate!.startTime!;
    final end = _selectDate!.endTime!;
  ...
  Widget build(BuildContext context) {
    ...
    return AppScaffold(
        ...
        // (ดู PHASE3_PAGE_DESIGN.md ข้อ 1 + หัวข้อ /attendance-request/create)
                                            ...
                                            Expanded(
                                                child: Container(
                                                    decoration: BoxDecoration(
                                                      ...
                                                      border: (_submitted && _selectDate?.startTime == null || _isInvalidTimeRange())
                                            ...
                                            Expanded(
                                                child: Container(
                                                    decoration: BoxDecoration(
                                                      color: Colors.white,
                                                      borderRadius: BorderRadius.circular(22),
                                                      border: (_submitted && _selectDate?.endTime == null || _isInvalidTimeRange())
                                                          ? Border.all(color: Colors.red)
                                                          : null,
                                                    ),
                                                    child: Padding(
                                      ...
                                      child: (_submitted &&
                                        ...
                                        child: Text(
                                          (_selectDate?.startTime != null &&
                                              _selectDate?.endTime != null &&
                                              _isInvalidTimeRange())
                                              ? 'เวลาออกต้องมากกว่าหรือเท่ากับเวลาเข้า'
                            ...
                            if (setting!.specifyRemark) ...[
                              TextField(
                                ...
                                decoration: InputDecoration(
                                  errorText: (_submitted && setting!.requiredRemark && remarkController.text.isEmpty) ? 'กรุณาระบุหมายเหตุ' : null,
