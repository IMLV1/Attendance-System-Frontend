...
// import '../../shared/widgets/head_bar/moblie/header.dart';
//
...
class LoginPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // ใช้ Column เป็น body ตัวเดียว
      body: Column(
        children: [
          // ------------------------------------------
          // 1. ส่วน Header (อยู่บนสุด)
          // ------------------------------------------
          const Header(
            TitleThai: "Login najaa",
          ),

          // ------------------------------------------
          // 2. ส่วน Login Form (ใช้ Expanded ให้เต็มพื้นที่ที่เหลือ)
          // ------------------------------------------
          Expanded(
            child: Container(
              alignment: Alignment.center,
              // ย้าย Padding มาใส่ตรงนี้ Header จะได้กว้างเต็มจอ ส่วนเนื้อหาจะขยับเข้ามาสวยงาม
              padding: EdgeInsets.symmetric(horizontal: 20.r(context)),

              child: Column( // Column ของเนื้อหา Login
                mainAxisAlignment: MainAxisAlignment.center,
                spacing: 13.r(context),
                children: [
                  ConstrainedBox(
