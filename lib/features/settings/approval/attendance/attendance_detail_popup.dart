  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: ServiceLoader(
        ...
        onSuccess: (val) {
          setState(() {
            data = AttendanceApprovalModel.fromJson(val['data']);
          });
        },
        builder: () {
          return Column(
                                          ...
                                          if (setting!.approveNeedSignature) {
                                            ...
                                            await provider.push(context, ServiceSignaturePage(
                                              ...
                                              onSuccessResponse: (pngBytes, jsonData) {
                                                ...
                                                NotificationService().sendApprovalResponseNotification('ATTENDANCE_REQUEST', widget.reqId, 'REJECTED');
                                              },
                                            ));
                                          ...
                                          if (setting!.approveNeedSignature) {
                                            ...
                                            await provider.push(context, ServiceSignaturePage(
                                              ...
                                              onSuccessResponse: (pngBytes, jsonData) {
                                                ...
                                                NotificationService().sendApprovalResponseNotification('ATTENDANCE_REQUEST', widget.reqId, 'APPROVED');
                                              },
                                            ));
