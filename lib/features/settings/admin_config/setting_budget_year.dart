                                    ...
                                    AnimatedSizeWidget(
                                      ...
                                      child: SeparatorCard(
                                        ...
                                        children: [
                                          ...
                                          _buildModeOption(
                                            value: 'current',
                                            title: 'ขยายรอบปัจจุบันถึงวันตัดรอบใหม่',
                                            description: 'ใช้ได้เมื่อวันตัดรอบใหม่อยู่หลังวันสิ้นสุดรอบปัจจุบัน '
                                                'หากอยู่ก่อน ระบบจะเริ่มใช้ปีงบประมาณถัดไปให้แทน (ไม่ย่นรอบปัจจุบัน)',
                                          ),
                                        ],
                                      ),
                                    ),
