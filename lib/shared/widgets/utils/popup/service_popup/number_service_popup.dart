...
class NumberServicePopup {
  final String title;
  final String buttonLabel;
  final void Function(double value)? onSuccess;
  final Future<Response<dynamic>> Function(double value) request;
  ...
  void showPopup(BuildContext context) {
    ...
    ServicePopup(
        ...
        minHeight: minHeight,
        maxHeight: maxHeight,
        request: () => request(_formatter.parse(controller.text).toDouble()),
        fit: fit,
        onSuccess: (context) {
